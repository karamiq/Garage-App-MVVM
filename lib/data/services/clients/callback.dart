import 'package:nafarat/data/models/default_response.dart';
import 'package:nafarat/data/models/paginated_response.dart';
import 'package:retrofit/retrofit.dart';
export 'package:retrofit/retrofit.dart';
export 'package:nafarat/data/models/paginated_response.dart';
export 'package:nafarat/data/models/default_response.dart';
